  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-slate-950 px-4">
      ...
      <div className="flex items-center gap-2 mb-8 z-10">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center font-bold text-white shadow-lg shadow-indigo-500/20 text-xl">
          A
        </div>
      ...
      <div className="relative z-10">
        <SignUp forceRedirectUrl="/onboarding/setup" />
      </div>
    </div>
  );
}
